...
const REVEAL_BASE_DIAMETER = 200; // px
...
// Vintage cartoon iris feel: 600 ms with an S-curve so the iris eases in,
// glides through the middle, then settles to a stop instead of snapping.
const ZOOM_MS = 600;
